        ...
        <div>
                ...
                </span>
                {
                    profile.certifications.map((certification, index) => {
                        ...
                        return(
                            <div key={index} className='shadow-md text-green bg-white w-full rounded-lg mb-5 p-2 flex flex-cols justify-between'>
                                <div key={index + JSON.stringify(certification)}>
                                    ...
                                    <a  key={index + certification.url} className='text-sm lg:text-base text-purpled mb-4' href={certification.url}>{certification.url}</a>
                                </div>
