                         ...
                         profile.organizations.map((organization, index) => {
                              ...
                              return(
                                   <div key={index} className='bg-white rounded-lg w-full lg:w-1/5 shadow-md p-2 lg:h-fit'>
                                        <h1 key={index + organization.name} className=' font-bold text-center mb-3'>{organization.name}</h1>
                                        ...
                                        <h1 key={organization.title} className='text-xs lg:text-base text-right  mt-8 capitalize'>{startDate.toLocaleString('es-ES', opts)} - {endDate.toLocaleString('es-ES', opts)}</h1>
                                   </div>
                              );
                         })
                    }
