                    ...
                    return company.profile_positions.map(position => {
                        ...
                        return(
                            <div className='shadow-md text-green bg-white w-full rounded-lg mb-5 p-2'>
                                <h1 className='text-md lg:text-xl'>{position.title} en</h1>
                                <h1 className='text-sm lg:text-md text-purpled mb-4'>{position.company}</h1>
                                <p className='text-sm lg:text-md text-purpled'>{position.description}</p>
                                <h1 className='text-sm  lg:text-md text-right text-green mt-8 capitalize'>{startDate.toLocaleString('es-ES', opts)} - {endDate.toLocaleString('es-ES', opts)}</h1>
                            </div>
                        )
                    })
                })
