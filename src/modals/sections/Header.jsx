...
export default function Header({profile}){
     return(
        <div>
            <h1 className='text-4xl text-green text-center '>{`${profile.first_name} ${profile.last_name}`}</h1>
            <h2 className='mt-2 text-sm text-purpled flex justify-center w-full'>{
            ...
            <h2 className='mt-2 text-md text-purpled mx-3 text-center'>{`${profile.sub_title}`}</h2>
            <div className='mt-5 flex flex-cols w-full flex justify-around '>
