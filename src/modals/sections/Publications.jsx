                         ...
                         profile.publications.map((publication, index) => {
                              return(
                                   <a href={publication.url} key={index} className='hover:scale-110 transition bg-white rounded-lg w-full lg:w-1/5 shadow-md p-2 lg:h-fit'>
                                        <h1 key={index + publication.title} className=' font-bold text-center mb-3'>{publication.name}</h1>
                                        ...
                                        <h1 key={publication.title} className='text-xs lg:text-base text-right  mt-8 capitalize'>{publication.date.year}</h1>
                                   </a>
                              );
                         })
                    }
